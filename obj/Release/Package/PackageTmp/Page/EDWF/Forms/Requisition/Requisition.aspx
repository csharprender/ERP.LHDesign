<%@ Page Title="" Language="C#" MasterPageFile="~/Page/EDWF/Forms/Control.Master" AutoEventWireup="true" CodeBehind="Requisition.aspx.cs" Inherits="ERP.LHDesign2020.Page.EDWF.Forms.Requisition.Requisition" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script>
        var This = "Requisition.aspx";
        ...
        function Selcontract(json) {
            $.ajax({
                type: "POST",
                url: This + "/Selcontract",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    ...
                    $('#Divcontract').modal('hide');
                    $('#Txtcontract').val(response.d['Documentno']);
                    $('#Txtcontract').attr('data-value', response.d['Refercontractid']);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if ($('#HdINQ').val() == "1") { //Inquiry
                        ...
                        $('#Spdocumentno').html(response.d['Documentno']);
                        Selcontract('x :' + response.d['Refercontractid'] + '|');
                        Calc();
                        Renderupload();
        ...
        function Save() {
            ...
            json += 'Txtcontract: ' + $('#Txtcontract').attr('data-value') + '|';
            ...
            $("[id*='Txtinvoice']").each(function () {
                    
                    json += $(this).attr('id') + ':' + $(this).val() + "|";
                
            });
            $("[id*='Txtpaymentdate']").each(function () {
        ...
        function Searchcontract() {
            ...
            ClearResource('Gvcontract');
            var Columns = ["เลขที่ใบสัญญา!L","ระยะสัญญา!L", "ลูกค้า!L","Site งาน!"];
            var Data = ["Documentno", "Contractdate", "Fullname","Sitename"];
            var Searchcolumns = ["เลขที่ใบสัญญา", "ลูกค้า", "Site งาน"];
            var SearchesDat = ["Documentno", "Fullname", "Sitename"];
            var Width = ["30%", "10%", "30%", "30%"];
            var grdcontract = new Grid(Columns, SearchesDat, Searchcolumns, 'Gvcontract', 30, Width, Data, "", '', '1', '', '', '', '', '', '', 'id', 'id', '', 'id', '', '');
            $('#Divcontractcont').html(grdcontract._Tables());
            grdcontract._Bind();

        }
        function Newcontract() {
            $('#Divcontract').modal('show');
            Searchcontract();
        }
    </script>
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col-8" style="text-align: right;">
                <span>เอกสารสัญญา</span>
            </div>
            <div class="col-4">
                <div class="input-group mb-3">
                   <input type="text" class="form-control" readonly="readonly" id="Txtcontract" data-value="" />
                   <button class="btn btn-info" onclick="Newcontract();"><i class="fa fa-search"></i></button>
                </div>
            </div>
        </div>
        <div class="row mt-3">
         ...
         <div class="row mt-3">
           ...
           <div class="row mt-3">
            <div class="col-9" style="text-align:right;">
                <span>วันที่แจ้งหนี้</span> &nbsp<span class="sp-require">*</span>
            </div>
            <div class="col-3">
               <div class='input-group date' id='Dtpinvoicedate'>
                    <input id="Txtinvoicedate" style="cursor:pointer;" readonly="readonly" class="form-control" type="text" />
                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                </div>
            </div>
        </div>
          <div class="row mt-3">
            <div class="col-9" style="text-align:right;">
                <span>วันที่ครบกำหนดชำระ</span> &nbsp<span class="sp-require">*</span>
            </div>
            <div class="col-3">
               <div class='input-group date' id='Dtppaymentdate'>
                    <input id="Txtpaymentdate" style="cursor:pointer;" readonly="readonly" class="form-control" type="text" />
                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                </div>
            </div>
        </div>
     ...
     <div class="modal" id="Divcontract" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg" >
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container" id="Divcontractcont" style="border: solid 1px lightgray; margin-right: 10px; min-height: 320px; padding: 8px;">
                    </div>
                </div>
                <!-- Modal footer -->
