...
namespace ERP.LHDesign2020.Page.EDWF.Forms.Contact
{
    public partial class Contact : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                HttpContext.Current.Session.Remove("EFORM001");
        ...
        public static string Deleteattachment(string json)
        {
            ...
            if (HttpContext.Current.Session["EFORM001"] != null)
            {
                foreach (ClsAttachment obj in ((CLSEForm001)HttpContext.Current.Session["EFORM001"]).Attachments)
                {
                    if (obj.Attachmentid == json)
                    {
                        ...
                        {
                            ((CLSEForm001)HttpContext.Current.Session["EFORM001"]).Attachments.Remove(obj);
                            return "";
                        }
                        else
                        {
        ...
        {
            CLSEForm001 Obj = new CLSEForm001();
            Obj = (CLSEForm001)HttpContext.Current.Session["EFORM001"];
            return Obj.Attachments;
        }
        [WebMethod]
        public static string Savestate(string json)
        {
            List<ClsEForm001Period> Objs = new List<ClsEForm001Period>();
            ClsEForm001Period Obj;
        ...
        [WebMethod]
        public static List<ClsEForm001Period> Renderperiod()
        {
            if (HttpContext.Current.Session["Period"] != null)
            {
                return (List<ClsEForm001Period>)HttpContext.Current.Session["Period"];
            }
            else
            {
                List<ClsEForm001Period> Periods = new List<ClsEForm001Period>();
        ...
        {
            List<ClsEForm001Period> Periods = new List<ClsEForm001Period>();
            ClsEForm001Period Obj = new ClsEForm001Period();
            try
            {
        ...
        [WebMethod]
        public static CLSEForm001 GetDocumentInfo(string json)
        {
            const string Eformcode = "EFORM001";
            CLSEForm001 Obj = new CLSEForm001();
            ...
            try
            {
                if (HttpContext.Current.Session["EFORM001"] != null)
                {
                    return (CLSEForm001)HttpContext.Current.Session["EFORM001"];
                }
                ...
                Dt = new DataTable();
                Sqlcmd = "select * from [Sys_Edocument_Eform001] Where Transbatchid='" + ((ClsInfo)HttpContext.Current.Session["Info"]).TransBatchId + "'";
                Dt = Cn.Select(Sqlcmd);
                ...
                if (Dt.Rows.Count > 0)
                {
                    ...
                    {
                        Obj.Documentno = ClsEngine.GenerateRunningno(_Eformcode, Connectionstring, "Sys_Edocument_Eform001", "id");
                    }
                    try
                    {
                    ...
                    Sqlcmd = "Select e001.*,convert(nvarchar,e001.CreateDate,103) as opendate,e001.isdelete from  Sys_EDocument_Eform001 e001  where e001.isdelete = 0 and e001.Transbatchid = '" + ((ClsInfo)HttpContext.Current.Session["Info"]).TransBatchId + "'";
                    Dt = new DataTable();
                    Dt = Cn.Select(Sqlcmd);
                    ...
                    List<ClsEForm001Period> Periods = new List<ClsEForm001Period>();
                    Dt = new DataTable();
                    Sqlcmd = "Select * from Sys_EDocument_Eform001detail where Transbatchid = '" + ((ClsInfo)HttpContext.Current.Session["Info"]).TransBatchId + "' and isdelete = 0 order by id ";
                    Dt = Cn.Select(Sqlcmd);
                    ClsEForm001Period Objperiod;
                    foreach (DataRow s_dr in Dt.Rows)
                    {
                        Objperiod = new ClsEForm001Period();
                ...
                Obj.Err = "";
                HttpContext.Current.Session["EFORM001"] = Obj;
                //  
                return Obj;
            }
            catch (Exception ex)
        ...
        public static string CallBackUpload(string Label, string Running)
        {
            ...
            Attachements = ((CLSEForm001)HttpContext.Current.Session["EFORM001"]).Attachments;
            ...
            ((CLSEForm001)HttpContext.Current.Session["EFORM001"]).Attachments = Attachements;
            Cn.Close();
            return "";
        ...
        public static string Save(string json)
        {
            ...
            Clsuser ObjMy;
            DataTable Dt = new DataTable();
            CLSEForm001 ObjEform = new CLSEForm001();
            string DocumentNo = ClsEngine.GenerateRunningno("EFORM001", Connectionstring, "Sys_Edocument_Eform001", "id");
            ...
            //======================================  Tranaction  =========================================
            ObjEform.Periods = new List<ClsEForm001Period>();
            ObjEform.Periods = (List<ClsEForm001Period>)HttpContext.Current.Session["Period"];
            ...
            ObjEform.ContId = ClsEngine.FindValue(Dicts, "contactorid");
            ObjEform.fullname = ClsEngine.FindValue(Dicts, "contactorname");
            ObjEform.address = ClsEngine.FindValue(Dicts, "contactoraddress");
            ObjEform.Tel = ClsEngine.FindValue(Dicts, "contactortel");
            ObjEform.Contactdate = ClsEngine.FindValue(Dicts, "Contactdate");
            ObjEform.Cardid = ClsEngine.FindValue(Dicts, "contactorcardID");
            ObjEform.Expirydate = ClsEngine.FindValue(Dicts, "contactorexprirydate");
            ObjEform.Bankid = ClsEngine.FindValue(Dicts, "contactorbank");
            ObjEform.Banknameth = ClsEngine.FindValue(Dicts, "contactorbanktext");
            ObjEform.Bankaccountno = ClsEngine.FindValue(Dicts, "contactorbankaccountno");
            ObjEform.Bankaccountname = ClsEngine.FindValue(Dicts, "contactorbankaccountname");
            ObjEform.Bankaccounttype = ClsEngine.FindValue(Dicts, "contactorbankaccountype");
            ...
            if (ObjCurrentState.NodeTypeId == "1") //Current Node
            {
                ...
                TransformId = ClsEngine.GenerateRunningId(Connectionstring, "Sys_Edocument_Eform001", "Id");


                sqlcmd = "";
                sqlcmd += " INSERT INTO [Sys_Edocument_Eform001] ";
                sqlcmd += " ([id] ";
            ...
            else //ถ้ามีอยู่แล้ว
            {
                ...
                {
                    sqlcmd = " Update Sys_EDocument_Eform001 set ";
            ...
            sqlcmd = "Update Sys_EDocument_Eform001detail set isdelete =1,deletedate=getdate(),deleteby='" + ObjMy.userid + "'  Where TransBatchId ='" + TransBatchId + "'";
            Arrcmd.Add(sqlcmd);
            string _detailid = ClsEngine.GenerateRunningId(Cn.Connectionstring, "Sys_EDocument_Eform001detail", "Id");
            foreach (ClsEForm001Period period in ObjEform.Periods)
            {
                if (period.Amount == "")
                {
                    period.Amount = "0.00";
                ...
                sqlcmd = "";
                sqlcmd += " INSERT INTO [Sys_EDocument_Eform001detail] ";
                sqlcmd += " ([id]";
                sqlcmd += " ,[TransBatchId]";
                sqlcmd += " ,[Period]";
                sqlcmd += " ,[PeriodName]";
            ...
            string attachmentid = "";
            int count = 0;
            foreach (ClsAttachment _attch in ((CLSEForm001)(HttpContext.Current.Session["EFORM001"])).Attachments)
            {
                count += 1;
                if (count < ((CLSEForm001)(HttpContext.Current.Session["EFORM001"])).Attachments.Count)
                {
            ...
            Attachs = ((CLSEForm001)(HttpContext.Current.Session["EFORM001"])).Attachments;
